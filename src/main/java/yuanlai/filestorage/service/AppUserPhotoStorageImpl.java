...
public class AppUserPhotoStorageImpl implements UserPhotoStorage {
	...
	public String save(byte[] bytes, int userId) throws IOException {
		...
		File userFolder = PhotoStorageUtils.getUserFolderFile(config.getAppUserFolder(), userId);
	...
	public int[] getSize(int userId, String name) throws IOException {
		File file = PhotoStorageUtils.getPhotoFile(PhotoStorageUtils.getUserFolderFile(config.getAppUserFolder(), userId),
				name);
